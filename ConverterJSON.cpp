...
std::vector<std::string> ConverterJSON::GetTextDocuments(std::string configWay){
...
int ConverterJSON::GetResponsesLimit(std::string configWay){
    std::ifstream config(configWay);
    nlohmann::json configRecord;
    config >> configRecord;
...
std::vector<std::string> ConverterJSON::GetRequests(std::string requestsWay){
...
void ConverterJSON::putAnswers(std::vector<std::vector<RelativeIndex>> answers, std::string answersWay, int max_responses){
...
void ConverterJSON::launch(std::string configWay){
